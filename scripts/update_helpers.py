...
theme_file = base / "utils" / "theme.py"
visual_file = base / "utils" / "visualization.py"
requirements_file = base / "requirements.txt"

theme_content = '''import streamlit as st
import base64
...
visual_content = '''import pandas as pd
...
print('theme.py, visualization.py, and requirements.txt updated')
